...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id B23BB4B1B73
	for <lists+linux-aspeed@lfdr.de>; Fri, 11 Feb 2022 02:44:50 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4JvxJ02XHDz3bN7
	for <lists+linux-aspeed@lfdr.de>; Fri, 11 Feb 2022 12:44:48 +1100 (AEDT)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=quantacorp.onmicrosoft.com header.i=@quantacorp.onmicrosoft.com header.a=rsa-sha256 header.s=selector2-quantacorp-onmicrosoft-com header.b=V4P3sMje;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.s=selector2-quantacorp-onmicrosoft-com header.b=V4P3sMje; 
 dkim-atps=neutral
Received: from APC01-HK2-obe.outbound.protection.outlook.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4JvxHl3hfYz30K4
...
Subject: [PATCH 01/10] arch: arm: dts: bletchley: switch sled numbering to
 1-based
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 11 Feb 2022 01:44:13.3858 (UTC)
