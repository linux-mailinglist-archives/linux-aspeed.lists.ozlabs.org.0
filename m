...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id A25EBDE137
	for <lists+linux-aspeed@lfdr.de>; Mon, 21 Oct 2019 01:31:26 +0200 (CEST)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 46xGHc0yl9zDqHh
	for <lists+linux-aspeed@lfdr.de>; Mon, 21 Oct 2019 10:31:24 +1100 (AEDT)
...
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [46.235.227.227])
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 46qRY367KtzDqTk
 for <linux-aspeed@lists.ozlabs.org>; Fri, 11 Oct 2019 23:07:49 +1100 (AEDT)
...
> >>>>>> AST2400 SMC driver. It adds Dual Data support and read training gi=
ving
> >>>>>> the best read settings for a given chip. Support for the new AST26=
00
...
> >>>>>> integrate the read training. The Aspeed constraints are not compat=
ible
...
> >>>>> drivers to spi-mem in the past. I do understand your concerns, and =
I'll
> >>>>> let the SPI NOR/MTD maintainers make the final call, but I think it=
'd
> >>>>> be better for the SPI MEM ecosystem to think about this link-traini=
ng
> >>>>> API (Vignesh needs it for the Cadence driver IIRC) rather than push=
ing
...
> >>>
> >>> Except it won't have the necessary APIs unless someone works on it, a=
nd
...
>=20
> We first read a golden buffer at low speed and then perform reads with=20
...
> size to configure the controller to access the CS on the AHB window.=20
