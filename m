...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by mail.lfdr.de (Postfix) with ESMTPS id B2DE82DDD6E
	for <lists+linux-aspeed@lfdr.de>; Fri, 18 Dec 2020 04:54:18 +0100 (CET)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 4Cxw3C2mTkzDqWq
	for <lists+linux-aspeed@lfdr.de>; Fri, 18 Dec 2020 14:54:15 +1100 (AEDT)
...
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 ...
 header.s=fm1 header.b=YjdWUNlQ; 
 dkim=pass (2048-bit key;
 unprotected) header.d=messagingengine.com header.i=@messagingengine.com
 header.a=rsa-sha256 header.s=fm1 header.b=C9sy6sj4; 
 dkim-atps=neutral
Received: from out2-smtp.messagingengine.com (out2-smtp.messagingengine.com
 [66.111.4.26])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 4Cxw2y6rL5zDqWW
 for <linux-aspeed@lists.ozlabs.org>; Fri, 18 Dec 2020 14:54:02 +1100 (AEDT)
...
Subject: [PATCH v6 1/6] mmc: core: Add helper for parsing clock phase
 properties
