...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 28F3B4B702F
	for <lists+linux-aspeed@lfdr.de>; Tue, 15 Feb 2022 17:32:59 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4Jympw4Ltwz3cGl
	for <lists+linux-aspeed@lfdr.de>; Wed, 16 Feb 2022 03:32:56 +1100 (AEDT)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=quantacorp.onmicrosoft.com header.i=@quantacorp.onmicrosoft.com header.a=rsa-sha256 header.s=selector2-quantacorp-onmicrosoft-com header.b=RZIRN3oH;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.s=selector2-quantacorp-onmicrosoft-com header.b=RZIRN3oH; 
 dkim-atps=neutral
Received: from APC01-SG2-obe.outbound.protection.outlook.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4JympT0nsQz2x9P
...
Subject: [PATCH v3 08/10] ARM: dts: aspeed: bletchley: add INA230 sensor on
 each sled
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 15 Feb 2022 16:32:08.9299 (UTC)
