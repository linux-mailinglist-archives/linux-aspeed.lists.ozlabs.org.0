...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 7AC696A79FF
	for <lists+linux-aspeed@lfdr.de>; Thu,  2 Mar 2023 04:24:21 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4PRxKX04Czz3cMm
	for <lists+linux-aspeed@lfdr.de>; Thu,  2 Mar 2023 14:24:16 +1100 (AEDT)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (1024-bit key; secure) header.d=jms.id.au header.i=@jms.id.au header.a=rsa-sha256 header.s=google header.b=TGv6dM8K;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; secure) header.d=jms.id.au header.i=@jms.id.au header.a=rsa-sha256 header.s=google header.b=TGv6dM8K;
	dkim-atps=neutral
Received: from mail-ed1-x532.google.com (mail-ed1-x532.google.com [IPv6:2a00:1450:4864:20::532])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4PRxKM2bjtz3cFN
	for <linux-aspeed@lists.ozlabs.org>; Thu,  2 Mar 2023 14:24:05 +1100 (AEDT)
Received: by mail-ed1-x532.google.com with SMTP id u9so12813918edd.2
        for <linux-aspeed@lists.ozlabs.org>; Wed, 01 Mar 2023 19:24:05 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=j0sy216jul+B2oJ6ibl9jYnHUXYIg05vtAZmbpzezlo=;
        b=
X-Gm-Message-State: AO0yUKXbiErukJkTKpQNy1Y0P7KWCa0YKzqnDdiemUun7AwnbDfFPQDd
	zmZZgcSfVgGD/Z/GwQrTmPQtAx0l5o/RKmWAvug=
