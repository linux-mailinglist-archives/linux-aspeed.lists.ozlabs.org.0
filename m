Return-Path: <linux-aspeed+bounces-3516-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-aspeed@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WIjdKE3ejmlSFgEAu9opvQ
	(envelope-from <linux-aspeed+bounces-3516-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-aspeed@lfdr.de>; Fri, 13 Feb 2026 09:18:21 +0100
X-Original-To: lists+linux-aspeed@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id CC0E5133E72
	for <lists+linux-aspeed@lfdr.de>; Fri, 13 Feb 2026 09:18:20 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4fC4mp3Ts7z2ydq;
	Fri, 13 Feb 2026 19:18:18 +1100 (AEDT)
X-Original-To: linux-aspeed@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=211.20.114.72
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1770970698;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1770970698; c=relaxed/relaxed;
	bh=4v8hvAA8vuWAeKtYgVy6iuLiViA4Q2yNvVNSL7FdBTc=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-ID:References:
	 In-Reply-To:To:CC; b=
...
Received: from TWMBX01.aspeed.com (mail.aspeedtech.com [211.20.114.72])
	...
	for <linux-aspeed@lists.ozlabs.org>; Fri, 13 Feb 2026 19:18:16 +1100 (AEDT)
...
X-Spamd-Result: default: False [1.49 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-3516-lists,linux-aspeed=lfdr.de];
