...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id C2507755E31
	for <lists+linux-aspeed@lfdr.de>; Mon, 17 Jul 2023 10:16:12 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.a=rsa-sha256 header.s=susede2_rsa header.b=AjwhRcLr;
...
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4R4FK64tJ3z2yTv
	for <lists+linux-aspeed@lfdr.de>; Mon, 17 Jul 2023 18:16:10 +1000 (AEST)
X-Original-To: linux-aspeed@lists.ozlabs.org
Delivered-To: linux-aspeed@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=suse.de header.i=@suse.de header.a=rsa-sha256 header.s=susede2_rsa header.b=AjwhRcLr;
	dkim=pass header.d=suse.de header.i=@suse.de header.a=ed25519-sha256 header.s=susede2_ed25519 header.b=tMT8r31Y;
	dkim-atps=neutral
...
Received: from smtp-out2.suse.de (smtp-out2.suse.de [IPv6:2001:67c:2178:6::1d])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4R1n2F3JcKz3bkn
	for <linux-aspeed@lists.ozlabs.org>; Thu, 13 Jul 2023 17:54:45 +1000 (AEST)
