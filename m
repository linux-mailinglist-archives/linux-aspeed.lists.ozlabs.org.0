...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id C86F32A7CFF
	for <lists+linux-aspeed@lfdr.de>; Thu,  5 Nov 2020 12:30:54 +0100 (CET)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 4CRhCt660MzDqty
	for <lists+linux-aspeed@lfdr.de>; Thu,  5 Nov 2020 22:30:50 +1100 (AEDT)
X-Original-To: linux-aspeed@lists.ozlabs.org
Delivered-To: linux-aspeed@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; spf=pass (sender SPF authorized)
 smtp.mailfrom=aspeedtech.com (client-ip=40.107.130.98;
...
Received: from APC01-HK2-obe.outbound.protection.outlook.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4CRh8Z2S70zDqs6
 for <linux-aspeed@lists.ozlabs.org>; Thu,  5 Nov 2020 22:27:57 +1100 (AEDT)
...
Received: from HK0PR06MB2786.apcprd06.prod.outlook.com (2603:1096:203:5b::22)
 by HK0PR06MB2355.apcprd06.prod.outlook.com (2603:1096:203:4c::12)
...
Thread-Topic: [v2 4/4] spi: aspeed: Add ASPEED FMC/SPI memory controller driver
...
x-forefront-antispam-report: CIP:255.255.255.255; CTRY:; LANG:en; SCL:1; SRV:;
 ...
 SFS:(376002)(346002)(136003)(39840400004)(366004)(396003)(66476007)(107886003)(6916009)(66446008)(66556008)(76116006)(2906002)(64756008)(4326008)(5660300002)(66946007)(86362001)(7416002)(55016002)(26005)(33656002)(316002)(186003)(478600001)(54906003)(55236004)(6506007)(8936002)(7696005)(8676002)(53546011)(52536014)(9686003)(71200400001)(83380400001);
 DIR:OUT; SFP:1102; 
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 05 Nov 2020 11:27:49.9858 (UTC)
...
Cc: "devicetree@vger.kernel.org" <devicetree@vger.kernel.org>,
 ...
 "robh+dt@kernel.org" <robh+dt@kernel.org>, BMC-SW <BMC-SW@aspeedtech.com>,
...
> /mnt/kernel/drivers/spi/spi-aspeed.c:488:27: warning: cast to pointer fro=
m
> integer of different size [-Wint-to-pointer-cast]
>    chip[cs].ahb_base_phy =3D (void __iomem *)start_addr_phy;
>                            ^
...
> /mnt/kernel/drivers/spi/spi-aspeed.c:619:44: warning: cast from pointer t=
o
> integer of different size [-Wpointer-to-int-cast]
...
> argument of type 'unsigned int', but argument 6 has type 'size_t' {aka 'l=
ong
...
>   dynamic_dev_dbg(dev, dev_fmt(fmt), ##__VA_ARGS__)
>   ^~~~~~~~~~~~~~~
> /mnt/kernel/include/linux/dev_printk.h:123:23: note: in expansion of macr=
o
> 'dev_fmt'
>   dynamic_dev_dbg(dev, dev_fmt(fmt), ##__VA_ARGS__)
>                        ^~~~~~~
...
>   dev_dbg(ast_ctrl->dev, "read op:0x%x, addr:0x%llx, len:0x%x\n",
>   ^~~~~~~
> /mnt/kernel/drivers/spi/spi-aspeed.c: In function 'aspeed_spi_dirmap_writ=
e':
...
> /mnt/kernel/drivers/spi/spi-aspeed.c:820:17: error: initialization of 'ss=
ize_t
> (*)(struct spi_mem_dirmap_desc *, u64,  size_t,  void *)' {aka 'long int
> (*)(struct spi_mem_dirmap_desc *, long long unsigned int,  long unsigned =
int,
> void *)'} from incompatible pointer type 'int (*)(struct spi_mem_dirmap_d=
esc
...
>                  ^~~~~~~~~~~~~~~~~~~~~~
> /mnt/kernel/drivers/spi/spi-aspeed.c:820:17: note: (near initialization f=
or
> 'aspeed_spi_mem_ops.dirmap_read')
> /mnt/kernel/drivers/spi/spi-aspeed.c:821:18: error: initialization of 'ss=
ize_t
> (*)(struct spi_mem_dirmap_desc *, u64,  size_t,  const void *)' {aka 'lon=
g int
> (*)(struct spi_mem_dirmap_desc *, long long unsigned int,  long unsigned =
int,
> const void *)'} from incompatible pointer type 'int (*)(struct
> spi_mem_dirmap_desc *, uint64_t,  size_t,  const void *)' {aka 'int (*)(s=
truct
> spi_mem_dirmap_desc *, long long unsigned int,  long unsigned int,  const
> void *)'} [-Werror=3Dincompatible-pointer-types]
>   .dirmap_write =3D aspeed_spi_dirmap_write,
>                   ^~~~~~~~~~~~~~~~~~~~~~~
> /mnt/kernel/drivers/spi/spi-aspeed.c:821:18: note: (near initialization f=
or
