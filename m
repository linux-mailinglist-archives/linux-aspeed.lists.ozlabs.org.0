...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 76CDF916A5B
	for <lists+linux-aspeed@lfdr.de>; Tue, 25 Jun 2024 16:30:42 +0200 (CEST)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (1024-bit key; unprotected) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.a=rsa-sha256 header.s=korg header.b=RvDVfhnW;
	dkim-atps=neutral
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4W7nLQ6r42z3fpg
	for <lists+linux-aspeed@lfdr.de>; Wed, 26 Jun 2024 00:30:38 +1000 (AEST)
X-Original-To: linux-aspeed@lists.ozlabs.org
Delivered-To: linux-aspeed@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.a=rsa-sha256 header.s=korg header.b=RvDVfhnW;
	dkim-atps=neutral
...
Received: from sin.source.kernel.org (sin.source.kernel.org [145.40.73.55])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4W7nLG0Ml1z2xb2
	for <linux-aspeed@lists.ozlabs.org>; Wed, 26 Jun 2024 00:30:29 +1000 (AEST)
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by sin.source.kernel.org (Postfix) with ESMTP id 63E4CCE1ACB;
...
Cc: Lee Jones <lee@kernel.org>, linux-aspeed@lists.ozlabs.org, Ma Ke <make24@iscas.ac.cn>, Neal Liu <neal_liu@aspeedtech.com>, linux-usb@vger.kernel.org, kernel-janitors@vger.kernel.org, LKML <linux-kernel@vger.kernel.org>, Julia Lawall <julia.lawall@inria.fr>, Andrew Jeffery <andrew@codeconstruct.com.au>, linux-arm-kernel@lists.infradead.org
