...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 4C59D6A6465
	for <lists+linux-aspeed@lfdr.de>; Wed,  1 Mar 2023 01:48:43 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4PRFwT1HFbz3c8W
	for <lists+linux-aspeed@lfdr.de>; Wed,  1 Mar 2023 11:48:41 +1100 (AEDT)
Authentication-Results: lists.ozlabs.org;
	dkim=fail reason="signature verification failed" (1024-bit key; secure) header.d=jms.id.au header.i=@jms.id.au header.a=rsa-sha256 header.s=google header.b=OcWWjKve;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; secure) header.d=jms.id.au header.i=@jms.id.au header.a=rsa-sha256 header.s=google header.b=OcWWjKve;
	dkim-atps=neutral
Received: from mail-ed1-x52f.google.com (mail-ed1-x52f.google.com [IPv6:2a00:1450:4864:20::52f])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4PRFwK6k5dz30Lt
	for <linux-aspeed@lists.ozlabs.org>; Wed,  1 Mar 2023 11:48:31 +1100 (AEDT)
Received: by mail-ed1-x52f.google.com with SMTP id h16so47434142edz.10
        for <linux-aspeed@lists.ozlabs.org>; Tue, 28 Feb 2023 16:48:31 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=E4nqFS4bUyvvbhYjM0gBTx6DKWNE9vnb92XDebUFGiQ=;
        b=
X-Gm-Message-State: AO0yUKWsMnysKNK9DH21vHMIv67Y9kKIZD/uERtqz/OQIeTjyaKdVo6r
	aAKdPWah+gdHM1tfOVrT/gJcSFUz5MKBPxFyJ5c=
