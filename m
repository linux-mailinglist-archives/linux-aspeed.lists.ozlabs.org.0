Return-Path: <linux-aspeed+bounces-3819-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-aspeed@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gLFVAKF4y2k3HwYAu9opvQ
	(envelope-from <linux-aspeed+bounces-3819-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-aspeed@lfdr.de>; Tue, 31 Mar 2026 09:32:49 +0200
X-Original-To: lists+linux-aspeed@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:21b9:f100::1])
	by mail.lfdr.de (Postfix) with ESMTPS id DD1093653EB
	for <lists+linux-aspeed@lfdr.de>; Tue, 31 Mar 2026 09:32:47 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4flKZL05fBz2yjV;
...
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1774942329;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1774942329; c=relaxed/relaxed;
	bh=OsoICE2uB0Y+L6MtwqLweLXt2sz8YdWbYWn8gUfl1jc=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-ID:References:
	 In-Reply-To:To:CC; b=
...
X-Spamd-Result: default: False [1.49 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3819-lists,linux-aspeed=lfdr.de];
	NEURAL_HAM(-0.00)[-0.920];
	RCVD_TLS_LAST(0.00)[];
	R_DKIM_NA(0.00)[];
	FORGED_RECIPIENTS_MAILLIST(0.00)[]
X-Rspamd-Queue-Id: DD1093653EB
