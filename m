...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id B871C96EA4B
	for <lists+linux-aspeed@lfdr.de>; Fri,  6 Sep 2024 08:28:38 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4X0RBX5hyTz3cC5
	for <lists+linux-aspeed@lfdr.de>; Fri,  6 Sep 2024 16:28:36 +1000 (AEST)
...
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1725604114;
	cv=pass; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1725604114; c=relaxed/relaxed;
	bh=/a3fmLxoiZoHer3nbvtXCi+p9e6DuNqkqeX2BgsIrCA=;
	h=ARC-Authentication-Results:DKIM-Signature:From:To:Cc:Subject:Date:
	 Message-Id:In-Reply-To:References:MIME-Version:Content-Type; b=
ARC-Authentication-Results: i=2; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=wiwynn.com; dkim=pass (2048-bit key; unprotected) header.d=wiwynn.com header.i=@wiwynn.com header.a=rsa-sha256 header.s=selector2 header.b=F3tqY5Xx; dkim-atps=neutral; spf=pass (client-ip=2a01:111:f400:feab::62f; helo=apc01-sg2-obe.outbound.protection.outlook.com; envelope-from=delphine_cc_chiu@wiwynn.com; receiver=lists.ozlabs.org) smtp.mailfrom=wiwynn.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=wiwynn.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=wiwynn.com header.i=@wiwynn.com header.a=rsa-sha256 header.s=selector2 header.b=F3tqY5Xx;
	dkim-atps=neutral
...
Received: from APC01-SG2-obe.outbound.protection.outlook.com (mail-sgaapc01on2062f.outbound.protection.outlook.com [IPv6:2a01:111:f400:feab::62f])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4X0RBV32vSz3057
	for <linux-aspeed@lists.ozlabs.org>; Fri,  6 Sep 2024 16:28:34 +1000 (AEST)
...
X-Microsoft-Antispam-Message-Info: 	=?us-ascii?Q?xA7xHydDZlxEe6vL4mq8wOSWksF8yms/ppn09fkvTDtGgLHCP+U9WMMBQA30?=
