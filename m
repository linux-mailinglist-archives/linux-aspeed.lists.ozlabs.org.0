...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id C047A96EA5B
	for <lists+linux-aspeed@lfdr.de>; Fri,  6 Sep 2024 08:29:16 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4X0RCG5dYzz3cSZ
...
ARC-Seal: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1725604151;
	cv=pass; b=
ARC-Message-Signature: i=2; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	...
	h=ARC-Authentication-Results:DKIM-Signature:From:To:Cc:Subject:Date:
	 Message-Id:In-Reply-To:References:MIME-Version:Content-Type; b=
ARC-Authentication-Results: i=2; lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=wiwynn.com; dkim=pass (2048-bit key; unprotected) header.d=wiwynn.com header.i=@wiwynn.com header.a=rsa-sha256 header.s=selector2 header.b=lEAtsT91; dkim-atps=neutral; spf=pass (client-ip=2a01:111:f400:feae::61e; helo=apc01-psa-obe.outbound.protection.outlook.com; envelope-from=delphine_cc_chiu@wiwynn.com; receiver=lists.ozlabs.org) smtp.mailfrom=wiwynn.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=quarantine dis=none) header.from=wiwynn.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=wiwynn.com header.i=@wiwynn.com header.a=rsa-sha256 header.s=selector2 header.b=lEAtsT91;
	dkim-atps=neutral
...
Received: from APC01-PSA-obe.outbound.protection.outlook.com (mail-psaapc01on2061e.outbound.protection.outlook.com [IPv6:2a01:111:f400:feae::61e])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4X0RCC2V6xz30RG
...
X-Microsoft-Antispam-Message-Info: 	=?us-ascii?Q?J8UxXsEtDBa3EC2W9MYIHgGefB/qfHOMfBOcGBuDbux6KwinV1FlhQCguHWv?=
