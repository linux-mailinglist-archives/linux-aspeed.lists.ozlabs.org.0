...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 2DEDA4B40CB
	for <lists+linux-aspeed@lfdr.de>; Mon, 14 Feb 2022 05:26:46 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4JxrlR5Fqgz3bXd
	for <lists+linux-aspeed@lfdr.de>; Mon, 14 Feb 2022 15:26:43 +1100 (AEDT)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=quantacorp.onmicrosoft.com header.i=@quantacorp.onmicrosoft.com header.a=rsa-sha256 header.s=selector2-quantacorp-onmicrosoft-com header.b=JlCM9btK;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.s=selector2-quantacorp-onmicrosoft-com header.b=JlCM9btK; 
 dkim-atps=neutral
Received: from APC01-PSA-obe.outbound.protection.outlook.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4Jxrl25pKJz3bSq
...
Subject: [PATCH v2 06/10] arch: arm: dts: bletchley: add interrupt support for
 sled io expander
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 14 Feb 2022 04:26:00.0743 (UTC)
