...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 383864B1B78
	for <lists+linux-aspeed@lfdr.de>; Fri, 11 Feb 2022 02:45:07 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4JvxJJ67Z2z3bcF
	for <lists+linux-aspeed@lfdr.de>; Fri, 11 Feb 2022 12:45:04 +1100 (AEDT)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=quantacorp.onmicrosoft.com header.i=@quantacorp.onmicrosoft.com header.a=rsa-sha256 header.s=selector2-quantacorp-onmicrosoft-com header.b=FqINrBTi;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.s=selector2-quantacorp-onmicrosoft-com header.b=FqINrBTi; 
 dkim-atps=neutral
Received: from APC01-HK2-obe.outbound.protection.outlook.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4JvxHp1H1Kz3bV8
...
Subject: [PATCH 07/10] arch: arm: dts: bletchley: add shunt-resistor for
 ADM1278
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 11 Feb 2022 01:44:16.3075 (UTC)
