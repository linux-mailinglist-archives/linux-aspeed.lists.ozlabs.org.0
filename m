...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id A46324B4677
	for <lists+linux-aspeed@lfdr.de>; Mon, 14 Feb 2022 10:43:36 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4Jxzn21cL5z3bYh
	for <lists+linux-aspeed@lfdr.de>; Mon, 14 Feb 2022 20:43:34 +1100 (AEDT)
...
Received: from mx0a-001b2d01.pphosted.com (mx0a-001b2d01.pphosted.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4Jxzmn4Xrnz3bVL
...
@@ -540,6 +550,8 @@ static int aspeed_spi_chip_adjust_window(struct aspee=
d_spi_chip *chip,
 	return 0;
 }
=20
...
master);
@@ -588,6 +600,8 @@ static int aspeed_spi_dirmap_create(struct spi_mem_di=
rmap_desc *desc)
...
=20
@@ -869,6 +883,249 @@ static u32 aspeed_spi_segment_ast2600_reg(struct as=
peed_spi *aspi,
...
+
  ...
  */
@@ -877,6 +1134,10 @@ static const struct aspeed_spi_data ast2400_fmc_dat=
a =3D {
 	.hastype       =3D true,
 	.we0	       =3D 16,
...
@@ -887,6 +1148,10 @@ static const struct aspeed_spi_data ast2400_spi_dat=
a =3D {
 	.hastype       =3D false,
 	.we0	       =3D 0,
 	.ctl0	       =3D 0x04,
...
=20
@@ -895,6 +1160,10 @@ static const struct aspeed_spi_data ast2500_fmc_dat=
a =3D {
 	.hastype       =3D true,
 	.we0	       =3D 16,
 	.ctl0	       =3D CE0_CTRL_REG,
...
+	.calibrate     =3D aspeed_spi_calibrate,
 	...
 	.segment_end   =3D aspeed_spi_segment_end,
 	.segment_reg   =3D aspeed_spi_segment_reg,
@@ -905,6 +1174,10 @@ static const struct aspeed_spi_data ast2500_spi_dat=
a =3D {
 	.hastype       =3D false,
 	.we0	       =3D 16,
 	.ctl0	       =3D CE0_CTRL_REG,
...
+	.calibrate     =3D aspeed_spi_calibrate,
 	...
 	.segment_end   =3D aspeed_spi_segment_end,
 	.segment_reg   =3D aspeed_spi_segment_reg,
@@ -916,6 +1189,10 @@ static const struct aspeed_spi_data ast2600_fmc_dat=
a =3D {
...
@@ -927,6 +1204,10 @@ static const struct aspeed_spi_data ast2600_spi_dat=
a =3D {
 	.mode_bits     =3D SPI_RX_QUAD | SPI_RX_QUAD,
 	.we0	       =3D 16,
 	.ctl0	       =3D CE0_CTRL_REG,
