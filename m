...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A2432F58D3
	for <lists+linux-aspeed@lfdr.de>; Thu, 14 Jan 2021 04:15:21 +0100 (CET)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 4DGTvm1LM3zDqxd
	for <lists+linux-aspeed@lfdr.de>; Thu, 14 Jan 2021 14:15:16 +1100 (AEDT)
...
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 ...
 header.s=fm1 header.b=cNZBRnuO; 
 dkim=pass (2048-bit key;
 unprotected) header.d=messagingengine.com header.i=@messagingengine.com
 header.a=rsa-sha256 header.s=fm1 header.b=fwa7iDCg; 
 dkim-atps=neutral
Received: from out2-smtp.messagingengine.com (out2-smtp.messagingengine.com
 [66.111.4.26])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 4DGTvH0hFxzDqXK
 for <linux-aspeed@lists.ozlabs.org>; Thu, 14 Jan 2021 14:14:50 +1100 (AEDT)
...
Subject: [PATCH v7 1/6] mmc: core: Add helper for parsing clock phase
 properties
