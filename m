...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id B4AD62D1FF2
	for <lists+linux-aspeed@lfdr.de>; Tue,  8 Dec 2020 02:27:02 +0100 (CET)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 4CqjFv5s9JzDqcD
	for <lists+linux-aspeed@lfdr.de>; Tue,  8 Dec 2020 12:26:59 +1100 (AEDT)
...
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 ...
 header.s=fm1 header.b=fACt2ITY; 
 dkim=pass (2048-bit key;
 unprotected) header.d=messagingengine.com header.i=@messagingengine.com
 header.a=rsa-sha256 header.s=fm1 header.b=J6sUETo3; 
 dkim-atps=neutral
Received: from out3-smtp.messagingengine.com (out3-smtp.messagingengine.com
 [66.111.4.27])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 4CqjFQ1yW3zDqbB
...
Subject: [PATCH v5 1/6] mmc: core: Add helper for parsing clock phase
 properties
