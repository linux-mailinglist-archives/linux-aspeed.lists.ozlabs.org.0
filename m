...
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 7467175E5C
	for <lists+linux-aspeed@lfdr.de>; Fri, 26 Jul 2019 07:40:26 +0200 (CEST)
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 45vybT4MMQzDqPn
	for <lists+linux-aspeed@lfdr.de>; Fri, 26 Jul 2019 15:40:21 +1000 (AEST)
...
Authentication-Results: lists.ozlabs.org; dkim=pass (2048-bit key;
 unprotected) header.d=aj.id.au header.i=@aj.id.au header.b="GO+MZCCs"; 
 dkim=pass (2048-bit key;
 unprotected) header.d=messagingengine.com header.i=@messagingengine.com
 header.b="GpbeM8O5"; dkim-atps=neutral
Received: from new4-smtp.messagingengine.com (new4-smtp.messagingengine.com
 [66.111.4.230])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 45vybG1Zf3zDqPS
...
Cc: mark.rutland@arm.com, linus.walleij@linaro.org, arnd@arndb.de,
 ...
 linux-kernel@vger.kernel.org, yao.yuan@linaro.org, venture@google.com,
 sschaeck@cisco.com, haiyue.wang@linux.intel.com
