...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AC504F7025
	for <lists+linux-aspeed@lfdr.de>; Thu,  7 Apr 2022 03:18:35 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4KYk6K1cqxz2ync
	for <lists+linux-aspeed@lfdr.de>; Thu,  7 Apr 2022 11:18:33 +1000 (AEST)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=quantacorp.onmicrosoft.com header.i=@quantacorp.onmicrosoft.com header.a=rsa-sha256 header.s=selector2-quantacorp-onmicrosoft-com header.b=GgKsuL2h;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.s=selector2-quantacorp-onmicrosoft-com header.b=GgKsuL2h; 
 dkim-atps=neutral
Received: from APC01-SG2-obe.outbound.protection.outlook.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4KYk682tpRz2xYG
...
Subject: [PATCH net-next v3 1/3] net: mdio: aspeed: move reg accessing part
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 07 Apr 2022 01:18:01.3963 (UTC)
