...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id CDF824F661A
	for <lists+linux-aspeed@lfdr.de>; Wed,  6 Apr 2022 19:01:53 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4KYW5C66K0z3bYq
	for <lists+linux-aspeed@lfdr.de>; Thu,  7 Apr 2022 03:01:51 +1000 (AEST)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=quantacorp.onmicrosoft.com header.i=@quantacorp.onmicrosoft.com header.a=rsa-sha256 header.s=selector2-quantacorp-onmicrosoft-com header.b=zPEZMFuq;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.s=selector2-quantacorp-onmicrosoft-com header.b=zPEZMFuq; 
 dkim-atps=neutral
Received: from APC01-TYZ-obe.outbound.protection.outlook.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4KYW524Q1mz2xB1
 for <linux-aspeed@lists.ozlabs.org>; Thu,  7 Apr 2022 03:01:42 +1000 (AEST)
...
Subject: [PATCH net-next RESEND v2 1/3] net: mdio: aspeed: move reg accessing
 part into separate functions
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 Apr 2022 17:01:20.4693 (UTC)
