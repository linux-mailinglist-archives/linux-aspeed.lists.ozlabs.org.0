...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id 9726ABC34A
	for <lists+linux-aspeed@lfdr.de>; Tue, 24 Sep 2019 09:48:50 +0200 (CEST)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 46ctc00MFwzDqS7
	for <lists+linux-aspeed@lfdr.de>; Tue, 24 Sep 2019 17:48:48 +1000 (AEST)
X-Original-To: linux-aspeed@lists.ozlabs.org
Delivered-To: linux-aspeed@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org;
 spf=pass (mailfrom) smtp.mailfrom=microchip.com
 (client-ip=68.232.153.233; helo=esa3.microchip.iphmx.com;
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.i=@microchiptechnology.onmicrosoft.com header.b="U9VxM/rQ"; 
 dkim-atps=neutral
Received: from esa3.microchip.iphmx.com (esa3.microchip.iphmx.com
 [68.232.153.233])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 46ctYs1wFYzDqSP
 for <linux-aspeed@lists.ozlabs.org>; Tue, 24 Sep 2019 17:46:57 +1000 (AEST)
...
@@ -836,6 +836,127 @@ static int spi_nor_read_sr2(struct spi_nor *nor, u8 *=
sr2)
 	return ret;
 }
=20
...
+
 ...
 {
 	return mtd->priv;
@@ -1492,24 +1613,6 @@ static int spi_nor_erase(struct mtd_info *mtd, struc=
t erase_info *instr)
 	return ret;
 }
=20
...
-
 static void stm_get_locked_range(struct spi_nor *nor, u8 sr, loff_t *ofs,
 				 uint64_t *len)
 {
@@ -1673,7 +1776,7 @@ static int stm_lock(struct spi_nor *nor, loff_t ofs, =
uint64_t len)
...
=20
 /*
@@ -1758,7 +1861,7 @@ static int stm_unlock(struct spi_nor *nor, loff_t ofs=
, uint64_t len)
 	if ((status_new & mask) > (status_old & mask))
 		return -EINVAL;
=20
...
+		nor->flags |=3D SNOR_F_HAS_16BIT_SR;
 		...
 		break;
=20
@@ -4515,6 +4638,8 @@ static void spi_nor_info_init_flash_params(struct spi=
_nor *nor)
 	flash->quad_enable =3D spansion_read_cr_quad_enable;
