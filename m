Return-Path: <linux-aspeed+bounces-3403-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-aspeed@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id VA/vAOafb2kcKAAAu9opvQ
	(envelope-from <linux-aspeed+bounces-3403-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-aspeed@lfdr.de>; Tue, 20 Jan 2026 16:31:50 +0100
X-Original-To: lists+linux-aspeed@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id B8D3D46143
	for <lists+linux-aspeed@lfdr.de>; Tue, 20 Jan 2026 16:31:47 +0100 (CET)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4dwRNj3SxJz30MY;
...
X-Spamd-Result: default: False [-0.71 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-3403-lists,linux-aspeed=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	DNSWL_BLOCKED(0.00)[100.75.92.58:received,172.105.4.254:received,112.213.38.117:from];
	FROM_NEQ_ENVFROM(0.00)[krzk@kernel.org,linux-aspeed@lists.ozlabs.org];
	DKIM_TRACE(0.00)[kernel.org:+];
	DWL_DNSWL_BLOCKED(0.00)[kernel.org:dkim];
	TAGGED_RCPT(0.00)[linux-aspeed,dt];
	RECEIVED_SPAMHAUS_BLOCKED_OPENRESOLVER(0.00)[172.105.4.254:received];
	TO_DN_SOME(0.00)[];
	RCVD_VIA_SMTP_AUTH(0.00)[];
	RBL_SENDERSCORE_REPUT_BLOCKED(0.00)[112.213.38.117:from]
