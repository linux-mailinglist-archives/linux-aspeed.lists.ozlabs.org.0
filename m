Return-Path: <linux-aspeed+bounces-4238-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-aspeed@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id Q5VBJV16KmrlqQMAu9opvQ
	(envelope-from <linux-aspeed+bounces-4238-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-aspeed@lfdr.de>; Thu, 11 Jun 2026 11:05:33 +0200
X-Original-To: lists+linux-aspeed@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 601716702CD
	for <lists+linux-aspeed@lfdr.de>; Thu, 11 Jun 2026 11:05:32 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=gmail.com header.s=20251104 header.b=ZqwQromZ;
	spf=pass (mail.lfdr.de: domain of "linux-aspeed+bounces-4238-lists+linux-aspeed=lfdr.de@lists.ozlabs.org" designates 112.213.38.117 as permitted sender) smtp.mailfrom="linux-aspeed+bounces-4238-lists+linux-aspeed=lfdr.de@lists.ozlabs.org";
	dmarc=pass (policy=none) header.from=gmail.com;
	arc=pass ("lists.ozlabs.org:s=201707:i=1")
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4gbcDp1VcFz3bqh;
	Thu, 11 Jun 2026 19:05:30 +1000 (AEST)
X-Original-To: linux-aspeed@lists.ozlabs.org
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1781168730;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1781168730; c=relaxed/relaxed;
	bh=r7GjD3bNiVFdAd4w+TgFaTKdjrHYv9XrlTWKOYR527Q=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=gmail.com; dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20251104 header.b=ZqwQromZ; dkim-atps=neutral; spf=pass (client-ip=2607:f8b0:4864:20::42d; helo=mail-pf1-x42d.google.com; envelope-from=kylehsieh1995@gmail.com; receiver=lists.ozlabs.org) smtp.mailfrom=gmail.com
Received: from mail-pf1-x42d.google.com (mail-pf1-x42d.google.com [IPv6:2607:f8b0:4864:20::42d])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lists.ozlabs.org (Postfix) with ESMTPS id 4gbcDl6drwz2xl6
	for <linux-aspeed@lists.ozlabs.org>; Thu, 11 Jun 2026 19:05:27 +1000 (AEST)
Received: by mail-pf1-x42d.google.com with SMTP id d2e1a72fcca58-842cd900ee0so2325991b3a.2
        for <linux-aspeed@lists.ozlabs.org>; Thu, 11 Jun 2026 02:05:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20251104; t=1781168726; x=1781773526; darn=lists.ozlabs.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=r7GjD3bNiVFdAd4w+TgFaTKdjrHYv9XrlTWKOYR527Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20251104; t=1781168726; x=1781773526;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-gg:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=r7GjD3bNiVFdAd4w+TgFaTKdjrHYv9XrlTWKOYR527Q=;
        b=
X-Forwarded-Encrypted: i=1; AFNElJ+yRN72oRUyeo6OUO+TgMUOZSydlZiGsN/S3RMmBUaT3oT2Dl4J53MT3RpxVNeAo8ZRuLme+rGKuWYhV7c=@lists.ozlabs.org
X-Gm-Message-State: AOJu0YwH+0782P62p2dk2P4Ei7AVb+Mx/9tUjIs4ko86CFSZWALszM1P
	8MEq2SyDANTSaaMQYEkCuLJUyky9OVZOotyWuo3T5obkSDq9R6kRi5TxBE9EoQ==
X-Gm-Gg: 
...
X-Spamd-Result: default: False [-0.71 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-4238-lists,linux-aspeed=lfdr.de];
