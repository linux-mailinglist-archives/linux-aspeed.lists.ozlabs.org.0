...
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 93C1F4F661B
	for <lists+linux-aspeed@lfdr.de>; Wed,  6 Apr 2022 19:01:57 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [IPv6:::1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4KYW5H4H1Bz2ypn
	for <lists+linux-aspeed@lfdr.de>; Thu,  7 Apr 2022 03:01:55 +1000 (AEST)
Authentication-Results: lists.ozlabs.org;
	dkim=pass (1024-bit key; unprotected) header.d=quantacorp.onmicrosoft.com header.i=@quantacorp.onmicrosoft.com header.a=rsa-sha256 header.s=selector2-quantacorp-onmicrosoft-com header.b=TJ8uwOry;
	dkim-atps=neutral
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.s=selector2-quantacorp-onmicrosoft-com header.b=TJ8uwOry; 
 dkim-atps=neutral
Received: from APC01-TYZ-obe.outbound.protection.outlook.com
 ...
 by lists.ozlabs.org (Postfix) with ESMTPS id 4KYW533Hp0z2xB1
...
Subject: [PATCH net-next RESEND v2 2/3] net: mdio: aspeed: Introduce read
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 Apr 2022 17:01:21.0317 (UTC)
