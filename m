Return-Path: <linux-aspeed+bounces-3816-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-aspeed@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OGbRDXl4y2k3HwYAu9opvQ
	(envelope-from <linux-aspeed+bounces-3816-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-aspeed@lfdr.de>; Tue, 31 Mar 2026 09:32:09 +0200
X-Original-To: lists+linux-aspeed@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E38336538E
	for <lists+linux-aspeed@lfdr.de>; Tue, 31 Mar 2026 09:32:08 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4flKZF6ZmPz2ybQ;
	Tue, 31 Mar 2026 18:32:05 +1100 (AEDT)
X-Original-To: linux-aspeed@lists.ozlabs.org
Authentication-Results: lists.ozlabs.org; arc=none smtp.remote-ip=211.20.114.72
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1774942325;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1774942325; c=relaxed/relaxed;
	bh=1booxj/4+s2/mOOmT994Kl+DJOj4mNF/QvMvMsul5xs=;
	h=From:Subject:Date:Message-ID:MIME-Version:Content-Type:To:CC; b=
...
Received: from TWMBX01.aspeed.com (mail.aspeedtech.com [211.20.114.72])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4flKZD6szgz2xSb;
	Tue, 31 Mar 2026 18:32:04 +1100 (AEDT)
...
X-Spamd-Result: default: False [1.49 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-3816-lists,linux-aspeed=lfdr.de];
	NEURAL_HAM(-0.00)[-0.893];
	RCVD_TLS_LAST(0.00)[];
	R_DKIM_NA(0.00)[];
	FORGED_RECIPIENTS_MAILLIST(0.00)[]
X-Rspamd-Queue-Id: 4E38336538E
