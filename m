...
Received: from lists.ozlabs.org (lists.ozlabs.org [203.11.71.2])
	by mail.lfdr.de (Postfix) with ESMTPS id CA164B5202
	for <lists+linux-aspeed@lfdr.de>; Tue, 17 Sep 2019 17:59:32 +0200 (CEST)
Received: from bilbo.ozlabs.org (lists.ozlabs.org [IPv6:2401:3900:2:1::3])
	by lists.ozlabs.org (Postfix) with ESMTP id 46XnqQ2vZpzF3Vr
	for <lists+linux-aspeed@lfdr.de>; Wed, 18 Sep 2019 01:59:30 +1000 (AEST)
...
Authentication-Results: lists.ozlabs.org; dkim=pass (1024-bit key;
 ...
 header.i=@microchiptechnology.onmicrosoft.com header.b="uUUy02hl"; 
 dkim-atps=neutral
Received: from esa4.microchip.iphmx.com (esa4.microchip.iphmx.com
 [68.232.154.123])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by lists.ozlabs.org (Postfix) with ESMTPS id 46XnmR2NpyzF3mf
 for <linux-aspeed@lists.ozlabs.org>; Wed, 18 Sep 2019 01:56:54 +1000 (AEST)
...
@@ -907,7 +907,7 @@ static int spi_nor_write_16bit_sr_and_check(struct spi_=
nor *nor, u8 status_new,
...
@@ -1963,81 +1963,34 @@ static int spi_nor_sr1_bit6_quad_enable(struct spi_=
nor *nor)
 }
=20
 /**
...
hat
  ...
  *
@@ -2138,7 +2091,7 @@ static int spi_nor_spansion_clear_sr_bp(struct spi_no=
r *nor)
...
=20
 	default:
@@ -4626,7 +4579,7 @@ static void spi_nor_info_init_flash_params(struct spi=
_nor *nor)
 	u8 i, erase_mask;
=20
