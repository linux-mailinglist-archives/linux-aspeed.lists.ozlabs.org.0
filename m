Return-Path: <linux-aspeed+bounces-3817-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>
Delivered-To: lists+linux-aspeed@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qGFAH4V4y2k3HwYAu9opvQ
	(envelope-from <linux-aspeed+bounces-3817-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>)
	for <lists+linux-aspeed@lfdr.de>; Tue, 31 Mar 2026 09:32:21 +0200
X-Original-To: lists+linux-aspeed@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [112.213.38.117])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FD833653AC
	for <lists+linux-aspeed@lfdr.de>; Tue, 31 Mar 2026 09:32:20 +0200 (CEST)
...
X-Spamd-Result: default: False [1.49 / 15.00];
	...
	TO_DN_SOME(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[lists.ozlabs.org:helo,lists.ozlabs.org:rdns,devicetree.org:url,aspeedtech.com:email,aspeedtech.com:mid,0.0.1.144:email];
	FROM_NEQ_ENVFROM(0.00)[billy_tsai@aspeedtech.com,linux-aspeed@lists.ozlabs.org];
	RCVD_COUNT_THREE(0.00)[4];
	TAGGED_FROM(0.00)[bounces-3817-lists,linux-aspeed=lfdr.de];
	NEURAL_HAM(-0.00)[-0.738];
	RCVD_TLS_LAST(0.00)[];
	R_DKIM_NA(0.00)[];
	FORGED_RECIPIENTS_MAILLIST(0.00)[]
X-Rspamd-Queue-Id: 9FD833653AC
