Return-Path: <linux-aspeed+bounces-1502-lists+linux-aspeed=lfdr.de@lists.ozlabs.org>
X-Original-To: lists+linux-aspeed@lfdr.de
Delivered-To: lists+linux-aspeed@lfdr.de
Received: from lists.ozlabs.org (lists.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee1:b9f1])
	by mail.lfdr.de (Postfix) with ESMTPS id 68B68ADF9FD
	for <lists+linux-aspeed@lfdr.de>; Thu, 19 Jun 2025 02:06:18 +0200 (CEST)
Received: from boromir.ozlabs.org (localhost [127.0.0.1])
	by lists.ozlabs.org (Postfix) with ESMTP id 4bN19L1T2Yz30Tf;
...
ARC-Seal: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707; t=1750239632;
	cv=none; b=
ARC-Message-Signature: i=1; a=rsa-sha256; d=lists.ozlabs.org; s=201707;
	t=1750239632; c=relaxed/relaxed;
	bh=Q5OJIlwxCPILPvMANCnxRdzbe15P023IP5KzMSRBVp0=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=
ARC-Authentication-Results: i=1; lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=gmail.com; dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20230601 header.b=iDaWmEYJ; dkim-atps=neutral; spf=pass (client-ip=2607:f8b0:4864:20::432; helo=mail-pf1-x432.google.com; envelope-from=leo.jt.wang@gmail.com; receiver=lists.ozlabs.org) smtp.mailfrom=gmail.com
Authentication-Results: lists.ozlabs.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: lists.ozlabs.org;
	dkim=pass (2048-bit key; unprotected) header.d=gmail.com header.i=@gmail.com header.a=rsa-sha256 header.s=20230601 header.b=iDaWmEYJ;
	dkim-atps=neutral
...
Received: from mail-pf1-x432.google.com (mail-pf1-x432.google.com [IPv6:2607:f8b0:4864:20::432])
	...
	by lists.ozlabs.org (Postfix) with ESMTPS id 4bMdyR1zRxz2xKN
	for <linux-aspeed@lists.ozlabs.org>; Wed, 18 Jun 2025 19:40:31 +1000 (AEST)
Received: by mail-pf1-x432.google.com with SMTP id d2e1a72fcca58-7424ccbef4eso5857405b3a.2
        for <linux-aspeed@lists.ozlabs.org>; Wed, 18 Jun 2025 02:40:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1750239629; x=1750844429; darn=lists.ozlabs.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Q5OJIlwxCPILPvMANCnxRdzbe15P023IP5KzMSRBVp0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Q5OJIlwxCPILPvMANCnxRdzbe15P023IP5KzMSRBVp0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXT5BOmn2wbYRaFnFpyGPieLE5Lr3TLYSbLtAFbb1J6gQ5spejn9bR9o5cr26wwvr3AmvlThTdXmeeVAFk=@lists.ozlabs.org
X-Gm-Message-State: AOJu0Yxc5cr96KBNI7PDZwW/Lz6TQuWCi48tzPZ7BwrIXzNfs6sS0h45
	TTt8/imZicQxHtPdtM58hgb0A98N5xTQkysCx5Uyw8qRcnyxWEYC7pOH
X-Gm-Gg: 
